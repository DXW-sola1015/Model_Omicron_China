...
|             | Gamma\_{p}            | 7x1                        | double | Rate for status transition. Row 1-7 refer to rate for E2I, rate for I2R, rate for Is2H, rate for H2D, rate for H2R, rate for ICU2D, rate for ICU2R.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | {p}=L indicates longer generation time setting                                                                                                                       |
